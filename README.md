...
默认 `kl_weight = train.vae_kl_weight = 0.0001`。较小的 KL 权重让模型优先学会清晰重建，适合教育项目先观察“编码-解码”是否工作。
...
| `outputs/flow_feature_maps.png` | `save_flow_feature_maps` | 展示单个样本经过 8 个 Flow 主干块后的真实中间层特征图 |
...
| `train.vae_kl_weight` | `0.0001` | VAE KL 散度损失权重 |
